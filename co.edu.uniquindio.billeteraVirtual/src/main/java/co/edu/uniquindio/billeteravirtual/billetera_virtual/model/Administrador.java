...
public class Administrador extends Persona implements IUsuarioServices, ICuentaServices, ITransaccionServices {
    ...
    public boolean agregarUsuario(String nombre, String apellido, String correo,
                                  String telefono, String idUsuario, String direccion) {
    ...
    @Override
    public boolean actualizarUsuario(String nombre, String apellido, String correo,
                                     String telefono, String idUsuarioActual, String idUsuario, String direccion) {
    ...
    public boolean autorizarLoginUsuario(String idUsuario, String contrasena) {
        ...
        for (Usuario usuario : getListaUsuarios()) {
            ...
            if (usuario.getIdUsuario().equalsIgnoreCase(idUsuario) &&
                    usuario.getContrasenaUsuario().equalsIgnoreCase(contrasena)) {
        ...
        for (Transaccion transaccion : listaTransacciones) {
            ...
            if ((transaccion.getCuentaOrigen() != null &&
                    ...
                    (transaccion.getCuentaDestino() != null &&
                            transaccion.getCuentaDestino().getUsuarioAsociado().
